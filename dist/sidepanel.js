...
const Bug = createLucideIcon$1("Bug", [
  [
    "rect",
...
const TaskExecutor = ({ steps, onComplete, onCancel }) => {
  ...
  const checkContentScript = async () => {
    try {
      ...
      addDebugInfo(`❌ Erro ao verificar content script: ${error2.message}`);
      return false;
    }
  };
  const injectContentScript = async () => {
    try {
      ...
      addDebugInfo(`❌ Erro geral na injeção: ${error2.message}`);
      return false;
    } finally {
  ...
  const executeStep = async (step, index) => {
    try {
      ...
      addDebugInfo(`❌ Erro no passo ${index + 1}: ${error2.message}`);
      throw error2;
    }
  };
  const startExecution = async () => {
    ...
    try {
      ...
      const errorMsg = `Erro geral: ${error2.message}`;
      addDebugInfo(`❌ ${errorMsg}`);
      setError(errorMsg);
      setIsExecuting(false);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    showDebug && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 text-green-400 p-3 rounded-lg text-xs font-mono max-h-40 overflow-y-auto", children: [
      debugInfo.map((info, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1", children: info }, index)),
      debugInfo.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500", children: "Nenhuma informação de debug ainda..." })
    ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          error.includes("content script") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-xs text-red-600", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "list-disc list-inside mt-1 space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Tente em uma página diferente (ex: google.com)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Verifique se não é uma página chrome:// ou chrome-extension://" })
            ] })
          ] })
        ] })
      ] }),
